...
#include "genKoopa.h"
using namespace std;
KoopaString ks;         // 保存KoopaIR
SymbolTableStack st;    // 符号表变量栈， 区分作用域， 保存符号
BlockController bc;     // 判断块情况（进入块/在块中/退出块）
WhileStack wst;         //
